...
namespace StonkBot.Services.TDAmeritrade.StreamingClient;

public class TdaStreamingClient : IDisposable
{
    private readonly ITdaApiClient _apiClient;
    ...
    public TdaStreamingClient(ITdaApiClient apiClient, IConsoleWriter con)
    {
